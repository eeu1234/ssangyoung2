...
public class Student {
	...
	private static void nextMyClass() {
		...
		for (myCourseApplicationDTO dto : list) {
			if(today.get(Calendar.DAY_OF_WEEK) == Integer.parseInt(dto.getDayCode())){
				...
				//교시
				switch (period) {
				case 1 : startHour = 9;	startMin=00; break;
				case 2 : startHour = 9; startMin=50;break;
				case 3 : startHour = 10; startMin=45;break;
				case 4 : startHour = 11;startMin=45; break;
				case 5 : startHour = 12; startMin=40;break;
				case 6 : startHour = 13;startMin=35; break;
				case 7 : startHour = 14; startMin=35;break;
				case 8 : startHour = 15; startMin=35;break;
				case 9 : startHour = 16; startMin=35;break;
				default : startHour = 0;startMin=00; break;
				}
	...
	public static void one() {
		...
		while(flag) {
		System.out.println("【학번】 or 【이름】 or 【교수】:");
